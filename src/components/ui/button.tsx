...
const buttonVariants = cva(
  cn(
    "inline-flex shrink-0 items-center justify-center gap-2 rounded-md text-lefot-text text-sm font-medium whitespace-nowrap transition-all outline-none disabled:pointer-events-none disabled:opacity-50 aria-invalid:border-destructive aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4 cursor-pointer",
  ...
  ),
  {
    variants: {
      variant: {
        ...
        destructive:
          "bg-lefot-bg-danger hover:bg-lefot-bg-danger-hover focus-visible:ring-lefot-border-danger/20",
      },
      size: {
        ...
        icon: "size-8",
        "icon-sm": "size-6 rounded-md [&_svg:not([class*='size-'])]:size-4",
        "icon-lg": "size-9",
      },
    },
    defaultVariants: {
