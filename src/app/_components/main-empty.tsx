  ...
  return (
   <div className="flex flex-col justify-center items-center gap-6 w-full h-screen">
      ...
      <p className="text-foreground-subtle text-center">
        <span>This application uses language model.</span><br/>
        <span>Please set at least one provider's API key to use the app.</span><br/>
...
export function EmptyProjectMain() {
  return (
   <div className="flex flex-col justify-center items-center gap-6 w-full h-screen">
      ...
      <p className="text-muted-foreground">Please create a new project to get started.</p>
      <Link href="/new">
